  ...
  return (
    <main className="min-h-screen bg-white text-slate-900 pt-28 pb-20">
      <section className="container mx-auto px-4 max-w-4xl">
        ...
        <p className="text-slate-700 mb-2">このプライバシーポリシーは、Chrome拡張機能「THE TOLL」および関連するWebアプリに適用されます。</p>
        <p className="text-slate-700 mb-10">ポートフォリオサイト全体に関する一般ポリシーではありません。</p>
