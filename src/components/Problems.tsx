...
const problems = [
    {
        ...
        solutionBorder: 'border-amber-100',
    },
    {
        icon: UserX,
        title: '丸投げ症候群',
        ...
        solutionBg: 'bg-rose-50',
        solutionBorder: 'border-rose-100',
    },
    {
        icon: ShieldAlert,
        title: 'セキュリティへの切実な懸念',
        ...
        solutionBorder: 'border-orange-100',
    },
    {
        icon: BookX,
        title: '教育不在の導入',
        ...
        solutionBorder: 'border-purple-100',
    },
    {
        icon: TrendingDown,
        title: '投資対効果の曖昧さ',
        ...
        solutionBg: 'bg-slate-50',
        solutionBorder: 'border-slate-100',
    },
];
...
const Problems = () => {
    ...
    return (
        <section ref={sectionRef} className="py-16 md:py-24 relative overflow-hidden bg-slate-50/50">
            {/* Background glow */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-blue-100/50 rounded-full blur-[100px] pointer-events-none mix-blend-multiply" />
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    ...
                    <p className="text-xl text-slate-600 max-w-2xl mx-auto font-light leading-relaxed">
                        ...
                        現場の皆様が<span className="text-blue-600 font-bold">「これなら使いこなせる」</span>と実感できる道を共に拓きます。
                    </p>
                </motion.div>
                    ...
                    {problems.map((item, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className={`modern-card p-8 flex flex-col h-full group ${index >= 3 ? 'lg:col-span-1 lg:last:col-start-2' : ''
                                    }`}
                            >
                                {/* Number + Icon */}
                                <div className="flex justify-between items-start mb-6">
                                    <span className="text-5xl font-bold text-slate-300 font-sans leading-none group-hover:text-slate-400 transition-colors">
                                        0{index + 1}
                                    </span>
                                    <div
                                ...
                                <p className="text-slate-600 text-sm leading-relaxed mb-8 flex-grow">{item.description}</p>

                                {/* Solution */}
                                <div className={`relative p-5 rounded-xl ${item.solutionBg} border ${item.solutionBorder} group-hover:border-blue-200 transition-colors`}>
                                    <div className="absolute top-0 left-0 w-1 h-full bg-blue-500 rounded-l-xl"></div>
                                    <div className="flex items-center gap-2 text-blue-600 text-xs font-bold font-mono uppercase tracking-wider mb-2">
